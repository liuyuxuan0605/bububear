...
//单包最大上限：与客户端 _DEF_MAX_PACK_SIZE 一致（10MB），
//收包时校验长度头，防止畸形/恶意包导致 new 超大内存把服务端打挂
#ifndef _DEF_MAX_PACK_SIZE
#define _DEF_MAX_PACK_SIZE  (10*1024*1024)
#endif
using namespace  std;
